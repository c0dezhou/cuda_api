...
//     // TODO 解决
//     int N =
//         1 << 20;  // large enough to ensure operations take noticeable time
...
//     cuLaunchKernel(cuFunction, N / 256, 1, 1, 256, 1, 1, 0, streamDefault,
//                    args1, nullptr);

//     void* args2[] = {&d_b, &d_a, &d_c, &N};
//     cuLaunchKernel(cuFunction, N / 256, 1, 1, 256, 1, 1, 0, streamNonBlocking,
//                    args2, nullptr);
